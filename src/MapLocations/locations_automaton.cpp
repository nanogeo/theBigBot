...
namespace sc2 {
	...
	void Locations::SetAutomatonLocations(Point3D start)
	{
		...
		bool swap = start.x == 29.5 && start.y == 65.5;

		this->start_location = start;

		base_locations = { P(154.5, 114.5),
							P(148.5, 145.5),
							P(127.5, 114.5),
							P(120.5, 153.5),
							P(85.5, 153.5),
							P(54.5, 151.5),
							P(150.5, 74.5),
							convert_location(Point2D(154.5, 114.5), !swap),
							convert_location(Point2D(148.5, 145.5), !swap),
							convert_location(Point2D(127.5, 114.5), !swap),
							convert_location(Point2D(120.5, 153.5), !swap),
							convert_location(Point2D(85.5, 153.5), !swap),
							convert_location(Point2D(54.5, 151.5), !swap),
							convert_location(Point2D(150.5, 74.5), !swap) };
		...
		std::vector<Point2D> blink_nat_attack_path = { P(64, 75),
														P(63, 62),
														P(59, 53),
														P(31, 33) };
		...
		std::vector<std::vector<Point2D>> blink_third_attack_path = { { P(63, 59),
																	P(52, 67) },
																	{ P(63, 59),
																	P(74, 48),
																	P(75, 39),
		...
		worker_rush_defense_group = P(162, 113.5);
		worker_rush_defense_attack = P(22, 66.5);

		warp_prism_locations = { P(89, 38),
								P(77, 86),
								P(27, 83),
								P(26, 40),
								P(56, 22) };

		main_ramp_forcefield_top = P(151, 129);
		main_ramp_forcefield_mid = P(149, 131);
	}
